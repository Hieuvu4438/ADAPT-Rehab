% =============================================================================
%  ADAPT-Rehab -- Figure 1: System Architecture Overview (Body)
...
%  Total visual width ≈ 19.7 cm with scale=0.90 (fits IEEE 2-col figure*)
...
% --- Red-accent Box (safety/pain components) ----------------------------------
\newcommand{\redbox}[4]{%
...
\begin{tikzpicture}[
  ...
  % ===========================================================================
  %  BACKGROUND COLUMNS (color-coded semantics)
  % ===========================================================================
  ...
  % --- C2→C4 cross-column: RTMW3D skeleton → Compensation Detector ---
  \draw[NeutralMid, line width=0.7pt, ->]
